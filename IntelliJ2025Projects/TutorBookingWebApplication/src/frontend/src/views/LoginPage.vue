  ...
  <div class="page-wrapper">
    <div class="container">
      ...
      <div class="cover">
        ...
        <div class="back">
          <img src="../assets/futuristic.png" alt=""/>
          <div class="text">
        ...
        <div class="form-content">
          <div class="login-form">
            ...
            <form @submit.prevent="submitLogin">
              <div class="input-boxes">
                <div class="input-box">
                  <i class="fas fa-envelope"><font-awesome-icon icon="envelope"/></i>
                  <input type="email" v-model="loginForm.email" placeholder="Enter your email" required />
                </div>
                <div class="input-box">
                  <i class="fas fa-lock"><font-awesome-icon icon="lock"/></i>
          ...
          <div class="signup-form">
            ...
            <form @submit.prevent="submitSignup">
              <div class="input-boxes">
                <div class="input-box">
                  <i class="fas fa-user"><font-awesome-icon icon="user"/></i>
                  <input type="text" v-model="signupForm.name" placeholder="Enter your name" required />
                </div>
                <div class="input-box">
                  <i class="fas fa-envelope"><font-awesome-icon icon="envelope"/></i>
                ...
                <div class="input-box">
                  <i class="fas fa-lock"><font-awesome-icon icon="lock"/></i>
                  <input type="password" v-model="signupForm.password" placeholder="Enter your password" required />
                </div>
                <div class="button input-box">
