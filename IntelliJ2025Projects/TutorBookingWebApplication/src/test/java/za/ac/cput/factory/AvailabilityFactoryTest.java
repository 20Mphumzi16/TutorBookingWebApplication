...
class AvailabilityFactoryTest {
    ...
    private static Availability availabilitySlot1;
    private static Availability availabilitySlot2;
...
//Roles
        ...
        availabilitySlot1=AvailabilityFactory.buildAvailability(1L,LocalDate.now(),LocalTime.of(22,00),LocalTime.of(23,00),tutor1,true);
        availabilitySlot2=AvailabilityFactory.buildAvailability(2L,LocalDate.now(),LocalTime.of(20,00),LocalTime.of(22,00),tutor2,false);

    }

    @Test
    void buildAvailability() {
        assertNotNull(availabilitySlot1);
        assertNotNull(availabilitySlot2);
        System.out.println(availabilitySlot1);
        System.out.println(availabilitySlot2);
    }
}